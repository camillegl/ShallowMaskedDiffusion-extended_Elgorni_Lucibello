...
- `paper/main-neuralnetworks.typ` existed but was a **stub** (title and outline only; abstract
  was "TODO"; it contained no equations); it was deleted in Phase 3A, committed at
  `ed42906cffd0b2b5989eb53e46f00ca6cdde4171` on `main` — see
  `docs/LEGACY_SCIENTIFIC_INDEX.md` and `docs/FINAL_REPOSITORY_MAP.md`.
...
## Phase 3A retirement documents (committed at `ed42906cffd0b2b5989eb53e46f00ca6cdde4171` on `main`)
